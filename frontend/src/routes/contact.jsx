    ...
    <div className="m-1 p-1">
      ...
      <div className="flex j-c a-i">
        <div className='bs-1 bd-1 bg-2 br-2 p-3 cw-1'>
          ...
          <input type="text" name='name' placeholder="John Smith" onChange={onChangeHandler} className="bs-2 br-2 cw-2 t-5 p-2 poppins"/>
          <label className="flex j-l a-i"><span className="material-symbols-rounded">email</span><p className="poppins">Email: </p></label>
          <input type="email" name='email' placeholder="someone@gmail.com" onChange={onChangeHandler} className="bs-2 br-2 cw-2 t-5 p-2 poppins"/>
          <label className="flex j-l a-i"><span className="material-symbols-rounded">message</span><p className="poppins">Message: </p></label>
          <textarea name='message' placeholder="Message..." onChange={onChangeHandler} className="bs-2 br-2 cw-2 t-5 p-2 poppins"></textarea> <br />
          <Form
                method="post"
                action="contact"
                onSubmit={(event) => {
          ...
          >
              <button className="bs-2 t-5 m-3 p-3 br-1 poppins">Send</button>
          </Form>
        </div>
      </div>
    </div>
